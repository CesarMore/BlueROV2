  	...
  	{	
		...
		//################# CICLO DEL CONTROLADOR #################
	  	if(controles == true)
	  	{
			...
			//Tf = 30;  	// Tiempo de trayectoria para el circulo y lineal
			...
			Kp_x=14, Ki_x=0.1, Kd_x=10;  
			
			Kp_y=6, Ki_y=0.01, Kd_y=0.15;
		...
		//ROS_INFO_STREAM("DatosPos_Y: " << tiempo2  << "\t" << eyy  << "\t" << uy_B << "\t" << usyy << "\t" << pos_y << "\t" << yd  << endl);
